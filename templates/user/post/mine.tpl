        ...
        <div class="inner">
            <form class="dzk_form" method="post" action="{modurl modname='Dizkus' type='user' func='viewlatest'}">
                <ul class="linklist z-clearfix">
                    <li><a class="dzk_arrow" href="{modurl modname='Dizkus' type='user' func='mine'}">{gt text="View your posts"}</a></li>
                    <li><a class="dzk_arrow" href="{modurl modname='Dizkus' type='user' func='mine' action='topics'}">{gt text="View your topics"}</a></li>
                </ul>
            </form>
        </div>
    </div>
