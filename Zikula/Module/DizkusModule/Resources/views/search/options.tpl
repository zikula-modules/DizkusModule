<div id="dzk_search">
    ...
    <div class="z-formnote z-informationmsg">{gt text='Notice: For forum searches, your search query must be between %1$s and %2$s characters long.' tag1=$modvars.ZikulaDizkusModule.minsearchlength tag2=$modvars.ZikulaDizkusModule.maxsearchlength domain="module_dizkus"}</div>
