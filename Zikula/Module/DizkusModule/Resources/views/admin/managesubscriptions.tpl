...
{pageaddvar name='javascript' value=$moduleInstance->getRelativePath()|cat:'/Resources/public/js/jQuery-Autocomplete-1.2.7/dist/jquery.autocomplete.min.js'}
{pageaddvar name="javascript" value=$moduleInstance->getRelativePath()|cat:'/Resources/public/js/Zikula.Dizkus.Admin.ManageSubscriptions.js'}
