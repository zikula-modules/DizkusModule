...
{pageaddvar name='javascript' value=$moduleBundle->getRelativePath()|cat:'/Resources/public/js/chosen_v0.14.0/chosen.jquery.min.js'}
{pageaddvar name='stylesheet' value=$moduleBundle->getRelativePath()|cat:'/Resources/public/js/chosen_v0.14.0/chosen.css'}
