...
<div class="panel panel-default">
    ...
    <table class='table'>
        ...
        <tbody>
            ...
            <tr>
                <td colspan='6' class='text-center'>{gt text="There is %s topic not in a child forum." plural="There are %s topics not in a subforum." tag1=$freeTopicsInForum count=$freeTopicsInForum}
