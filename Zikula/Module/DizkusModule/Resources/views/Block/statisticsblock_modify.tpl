<div class="form-group">
    ...
    <div class="col-lg-9">
        <input id="dizkus_template" type="text" class="form-control" name="dizkus[template]" value="{$vars.template|default:'statisticsblock.tpl'|safetext}" maxlength="100" />
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-lg-9">
        ...
        <p class="help-block">{gt text="Notice: Enter a comma-separated list. Example: 'maxposts=5,forum_id=27'."}<br />
            {gt text="Allowed parameters:"} <code>maxposts, maxforums, maxposters, months, forum_id, user_id, canread, favorites, show_m2f, show_rss</code></p>
    </div>
</div>