...
<div class="panel panel-default">
    <div class="panel-heading"><h2 class='fa fa-home'>&nbsp;{gt text="Forums index page"}</h2>
        ...
        <div style='position:absolute; top:0; right:0; padding: 1.25em;'>
            <a class='btn btn-default btn-sm tooltips' title="{gt text="RSS Feed"}" href="{route name='zikuladizkusmodule_user_feed'}"><i class='fa fa-rss-square fa-150x fa-orange'></i>
