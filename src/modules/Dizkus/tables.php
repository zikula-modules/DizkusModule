...
function Dizkus_tables()
{
    ...
    $ztable['dizkus_categories_column'] = array(
        'cat_id'    => 'cat_id',
        'cat_title' => 'cat_title',
        'cat_order' => 'cat_order'
    );
    $ztable['dizkus_categories_column_def'] = array(
        'cat_id'    => 'I AUTO PRIMARY',
    ...
    $ztable['dizkus_forum_mods_column'] = array(
        'id'       => 'id',
        'forum_id' => 'forum_id',
        'user_id'  => 'user_id'
    );
    $ztable['dizkus_forum_mods_column_def'] = array(
        'id'        => 'I AUTO PRIMARY',
        'forum_id'  => 'I NOTNULL DEFAULT 0',
        'user_id'   => 'I NOTNULL DEFAULT 0'
    );
    $ztable['dizkus_forum_mods_column_idx'] = array(
        'forum_id'  => 'forum_id',
        'user_id'   => 'user_id'
    );
    ...
    $ztable['dizkus_forums_column'] = array(
        'forum_id'               => 'forum_id',
    ...
    $ztable['dizkus_forums_column_def'] = array(
        'forum_id'               => 'I AUTO PRIMARY',
    ...
    $ztable['dizkus_forums_column_idx'] = array(
        'forum_last_post_id'  => 'forum_last_post_id',
        'forum_moduleref'     => 'forum_moduleref'
    );
    ...
    $ztable['dizkus_posts_column'] = array(
        'post_id'    => 'post_id',
        'topic_id'   => 'topic_id',
        'forum_id'   => 'forum_id',
        'poster_id'  => 'poster_id',
    ...
    $ztable['dizkus_posts_column_def'] = array(
        'post_id'     => 'I AUTO PRIMARY',
    ...
    $ztable['dizkus_posts_column_idx'] = array (
        'topic_id'   => 'topic_id',
        'forum_id'   => 'forum_id',
        'poster_id'  => 'poster_id',
        'post_msgid' => 'post_msgid'
    ...
    $ztable['dizkus_posts_text_column'] = array(
        'post_id'   => 'post_id',
        'post_text' => 'post_text'
    );
    $ztable['dizkus_posts_text_column_def'] = array(
        'post_id'    => 'I NOTNULL DEFAULT 0',
        'post_text'  => 'X NOTNULL DEFAULT \'\''
    );
    $ztable['dizkus_posts_text_column_idx'] = array(
        'post_id'  => 'post_id'
    );
    ...
    $ztable['dizkus_ranks_column'] = array(
        'rank_id'      => 'rank_id',
    ...
    $ztable['dizkus_ranks_column_def'] = array(
        'rank_id'       => 'I AUTO PRIMARY',
    ...
    $ztable['dizkus_ranks_column_idx'] = array(
        'rank_min'  => 'rank_min',
        'rank_max'  => 'rank_max'
    );
    ...
    $ztable['dizkus_subscription_column'] = array(
        'msg_id'   => 'msg_id',
        'forum_id' => 'forum_id',
        'user_id'  => 'user_id'
    );
    $ztable['dizkus_subscription_column_def'] = array(
        'msg_id'      => 'I AUTO PRIMARY',
        'forum_id'    => 'I NOTNULL DEFAULT 0',
        'user_id'     => 'I NOTNULL DEFAULT 0'
    );
    $ztable['dizkus_subscription_column_idx'] = array(
        'forum_id' => 'forum_id',
        'user_id'  => 'user_id'
    );
    ...
    $ztable['dizkus_topics_column'] = array(
        'topic_id'           => 'topic_id',
    ...
    $ztable['dizkus_topics_column_def'] = array(
        'topic_id'           => 'I AUTO PRIMARY',
        ...
        'solved'             => 'I(3) UNSIGNED NOTNULL DEFAULT 0',
        'forum_id'           => 'I NOTNULL DEFAULT 0'
    );
    $ztable['dizkus_topics_column_idx'] = array(
        'forum_id'           => 'forum_id',
        'topic_last_post_id' => 'topic_last_post_id'
    );
    ...
    $ztable['dizkus_topic_subscription_column'] = array(
        'id'       => 'id',
        'topic_id' => 'topic_id',
        'user_id'  => 'user_id'
    );
    $ztable['dizkus_topic_subscription_column_def'] = array(
        'id'        => 'I AUTO PRIMARY',
        'topic_id'  => 'I NOTNULL DEFAULT 0',
        'user_id'   => 'I NOTNULL DEFAULT 0'
    );
    $ztable['dizkus_topic_subscription_column_idx'] = array(
        'topic_id' => 'topic_id',
        'user_id'  => 'user_id'
    );
    ...
    $ztable['dizkus_forum_favorites_column'] = array(
        'forum_id' => 'forum_id',
        'user_id'  => 'user_id'
    );
    $ztable['dizkus_forum_favorites_column_def'] = array(
        'forum_id'  => 'I NOTNULL DEFAULT 0',
        'user_id'   => 'I NOTNULL DEFAULT 0'
    );
    $ztable['dizkus_forum_favorites_column_idx'] = array(
        'forum_id' => 'forum_id',
        'user_id'  => 'user_id'
    );

    //
    // users - obsolete since 3.2.0 as these data have been moved to attributes, remove in a later version
    //
    $ztable['dizkus_users'] = DBUtil::getLimitedTablename('dizkus_users');
    $ztable['dizkus_users_column'] = array(
        'user_id'         => 'user_id',
    ...
    $ztable['dizkus_users_column_def'] = array(
        'user_id'         => 'I PRIMARY',
