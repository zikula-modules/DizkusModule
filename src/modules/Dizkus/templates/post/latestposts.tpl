...
<div id="latestposts">
    ...
    <div class="roundedbar dzk_rounded">
        <div class="inner">
            <form class="dzk_form" method="post" action="{modurl modname='Dizkus' type=post func=viewlatest}">
                <ul class="linklist z-clearfix">
                    <li><a class="dzk_arrow" href="{modurl modname='Dizkus' type=post func=viewlatest selorder=3}">{gt text="Yesterday"}</a></li>
                    <li><a class="dzk_arrow" href="{modurl modname='Dizkus' type=post func=viewlatest selorder=2}">{gt text="Today"}</a></li>
                    <li><a class="dzk_arrow" href="{modurl modname='Dizkus' type=post func=viewlatest selorder=1}">{gt text="Last 24 hours"}</a></li>
                ...
                <ul class="linklist z-clearfix">
                    <li><a class="dzk_arrow" href="{modurl modname='Dizkus' type=post func=viewlatest selorder=4}">{gt text="Last week"}</a></li>
                    <li><a class="dzk_arrow" href="{modurl modname='Dizkus' type=post func=viewlatest selorder=4 unanswered=1}">{gt text="Last week, unanswered"}</a></li>
                    {if $last_visit_unix <> 0}
                    <li><a class="dzk_arrow" href="{modurl modname='Dizkus' type=post func=viewlatest selorder=6}">{gt text="Last visit"}</a></li>
                    {/if}
                </ul>
            </form>
        </div>
