...
<div id="dizkus_admin">
    ...
    <div class="z-clearfix" style="margin-top: 1em;">
        {button class="z-floatleft createnewcategory" src=edit_add.png set=icons/extrasmall __alt="Create new category" __title="Create new category" __text="Create new category"}
