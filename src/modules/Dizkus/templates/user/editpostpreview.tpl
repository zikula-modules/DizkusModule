    ...
    <div class="inner">
        ...
        <div class="dzk_subcols z-clearfix">
            ...
            <div class="postbody dzk_colpost_right">
                ...
                <div class="postinfo">
                    {if isset($topic)}<a class="dzk_img linktopostlink" style="margin-right: 5px;" href="{modurl modname='Dizkus' type=user func=viewtopic topic=$post.topic_id start=$topic.start}#pid{$post.post_id}" title="{gt text="Link to this post"}">{img modname='Dizkus' src='target.gif' __alt='Link to this post'}</a>{/if}
