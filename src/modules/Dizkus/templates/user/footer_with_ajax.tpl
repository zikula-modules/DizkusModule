...
<p id="dzk_footer_line">{gt text="Powered by "}<a href="http://code.zikula.org/dizkus/" title="Dizkus forum software for Zikula">Dizkus {modgetinfo modname=Dizkus info=version}</a></p>
