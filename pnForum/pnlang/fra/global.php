...
// B
//
define('_PNFORUM_BBCODE_BOLD_HINT', 'texte gras');
define('_PNFORUM_BBCODE_BOLD', 'b');
define('_PNFORUM_BBCODE_CODE_HINT', 'insérer du code');
define('_PNFORUM_BBCODE_CODE', 'Code');
define('_PNFORUM_BBCODE_COLOR_BLACK', 'Noir');
define('_PNFORUM_BBCODE_COLOR_BLUE', 'Bleu');
define('_PNFORUM_BBCODE_COLOR_BROWN', 'Marron');
define('_PNFORUM_BBCODE_COLOR_CYAN', 'Cyan');
define('_PNFORUM_BBCODE_COLOR_DARKBLUE', 'Bleu foncé');
define('_PNFORUM_BBCODE_COLOR_DARKRED', 'Rouge foncé');
define('_PNFORUM_BBCODE_COLOR_DEFAULT', 'Standard');
define('_PNFORUM_BBCODE_COLOR_DEFINE', 'couleur personnalisée');
define('_PNFORUM_BBCODE_COLOR_GREEN', 'Vert');
define('_PNFORUM_BBCODE_COLOR_HINT', 'sélectionner la couleur du texte');
define('_PNFORUM_BBCODE_COLOR_INDIGO', 'Indigo');
define('_PNFORUM_BBCODE_COLOR_OLIVE', 'Olive');
define('_PNFORUM_BBCODE_COLOR_ORANGE', 'Orange');
define('_PNFORUM_BBCODE_COLOR_RED', 'Rouge');
define('_PNFORUM_BBCODE_COLOR_TEXTCOLORCODE', 'entrez le code de la couleur');
define('_PNFORUM_BBCODE_COLOR_VIOLET', 'Violet');
define('_PNFORUM_BBCODE_COLOR_WHITE', 'Blanc');
define('_PNFORUM_BBCODE_COLOR_YELLOW', 'Jaune');
define('_PNFORUM_BBCODE_ENTER_EMAIL_ADDRESS','Entrez l\'adresse email que vous désirez ajouter :');
define('_PNFORUM_BBCODE_ENTER_LIST_ITEM','Entrez la nouvelle liste des items. Notez que chaque liste doit commencer par une ouverture de liste et se terminer par une fermeture de liste :');
define('_PNFORUM_BBCODE_ENTER_PAGE_TITLE','Titre de la page :');
define('_PNFORUM_BBCODE_ENTER_SITE_TITLE','Entrez le titre du site web :');
define('_PNFORUM_BBCODE_ENTER_TEXT_BOLD','Entrer le texte que vous voulez mettre en gras :');
define('_PNFORUM_BBCODE_ENTER_TEXT_ITALIC','Entrer le texte que vous voulez mettre en italique :');
define('_PNFORUM_BBCODE_ENTER_TEXT_UNDERLINE','entrez le texte à souligner');
define('_PNFORUM_BBCODE_ENTER_URL','Entrez l\'URL du lien à ajouter :');
define('_PNFORUM_BBCODE_ENTER_WEBIMAGE_URL','Entrez l\'URL de l\'image que vous voulre afficher :');
define('_PNFORUM_BBCODE_FONTCOLOR', 'Couleur de la police');
define('_PNFORUM_BBCODE_FONTSIZE', 'Taille de la police');
define('_PNFORUM_BBCODE_IMAGE_HINT', 'insérer une image');
define('_PNFORUM_BBCODE_IMAGE', 'Image');
define('_PNFORUM_BBCODE_ITALIC_HINT', 'texte italique');
define('_PNFORUM_BBCODE_ITALIC', 'i');
define('_PNFORUM_BBCODE_LISTCLOSE_HINT', 'fin de liste');
define('_PNFORUM_BBCODE_LISTCLOSE', '/ul');
define('_PNFORUM_BBCODE_LISTITEM_HINT', 'élément de liste');
define('_PNFORUM_BBCODE_LISTITEM', 'li');
define('_PNFORUM_BBCODE_LISTOPEN_HINT', 'debut de liste');
define('_PNFORUM_BBCODE_LISTOPEN', 'ul');
define('_PNFORUM_BBCODE_MAIL_HINT', 'insérer une adresse email');
define('_PNFORUM_BBCODE_MAIL', 'Adresse email');
define('_PNFORUM_BBCODE_QUOTE_HINT', 'insérer une citation');
define('_PNFORUM_BBCODE_QUOTE', 'Quote');
define('_PNFORUM_BBCODE_SIZE_DEFINE', 'taille personnalisée');
define('_PNFORUM_BBCODE_SIZE_HINT', 'Sélectionner la taille de la police');
define('_PNFORUM_BBCODE_SIZE_HUGE', 'Géant');
define('_PNFORUM_BBCODE_SIZE_LARGE', 'Grand');
define('_PNFORUM_BBCODE_SIZE_NORMAL', 'Normal');
define('_PNFORUM_BBCODE_SIZE_SMALL', 'Petit');
define('_PNFORUM_BBCODE_SIZE_TEXTSIZE', 'entrer la taille du texte');
define('_PNFORUM_BBCODE_SIZE_TINY', 'Minuscule');
define('_PNFORUM_BBCODE_UNDERLINE_HINT', 'texte souligné');
define('_PNFORUM_BBCODE_UNDERLINE', 'u');
define('_PNFORUM_BBCODE_URL_HINT', 'insérer un lien');
define('_PNFORUM_BBCODE_URL', 'URL');
...
define('_PNFORUM_DELETETOPIC_INFO', 'En appuyant sur le bouton de suppression à la fin de ce formulaire, le sujet sélectionné et tous les messages qui en dépendent seront <b>définitivement</b> supprimés.');
...
define('_PNFORUM_LOCKTOPIC_INFO', 'Quand vous pressez le bouton de verrouillage à la fin de ce formulaire, le sujet sélectionné sera <b>verrouillé</b>. Vous pourrez le déverouiller plus tard.');
...
define('_PNFORUM_MOVETOPIC_INFO', 'Quand vous pressez le bouton de déplacement à la fin de ce formulaire, le sujet sélectionné et les messages qu\'il contient seront <b>déplacés</b> vers le forum sélectionné. Note: vous n\'êtes autorisé à déplacer que vers les forums dont vous êtes modérateur. L\'administrateur peut déplacer n\importe quel sujet dans n\importe quel forum.');
...
define('_PNFORUM_PREFS_CHARSET', 'Jeu de caractères par défaut :<br /><i>(c\'est le jeu de caractères utilisé dans les en-têtes des emails)</i>');
define('_PNFORUM_PREFS_DESCENDING', 'Descendant');
define('_PNFORUM_PREFS_EMAIL', 'Adresse email de l\'expéditeur :<br /><i>(apparaîtra dans tous les emails envoyés par le forum)</i>');
...
define('_PNFORUM_PREFS_HOTTOPICICON', 'Icône de sujet brûlant :<br /><i>(sujet contenant beaucoup de messages)</i>');
define('_PNFORUM_PREFS_ICONS','<br /><strong>Icônes</strong>');
define('_PNFORUM_PREFS_LOGIP', 'Enregistrer les adresses IP :');
define('_PNFORUM_PREFS_MINPOSTINGSFORANCHOR', 'Nombre minimal de messages avant d\'insérer une ancre :<br /><i>une ancre permet à l\'utilisateur d\'aller directement au dernier message dans un vaste fil de discussion</i>');
define('_PNFORUM_PREFS_NEWPOSTSICON', 'Icône de nouveaux messages :<br /><i>(sujet contenant de nouveaux messages depuis la dernière visite)</i>');
...
define('_PNFORUM_PREFS_POSTSPERPAGE', 'Nombre de messages par page :<br /><i>(c\'est le nombre de messages d\'un sujet qui seront affichés par page. La valeur par défaut est 15)</i>');
...
define('_PNFORUM_PREFS_TOPICSPERPAGE', 'Nombre de sujets par page :<br /><i>(c\'est le nombre de sujets d\'un forum qui seront affichés par page. La valeur par défaut est 15)</i>');
...
define('_PNFORUM_STICKYTOPIC_INFO', 'Quand vous pressez le bouton de collage à la fin du formulaire, le sujet sera <b>collé</b>. Vous pourrez le décoller ultérieurement.');
...
define('_PNFORUM_UNLOCKTOPIC_INFO', 'Quand vous pressez le bouton de déverrouillage à la fin du formulaire, le sujet sélectionné sera <b>déverouillé</b>. Vous pourrez le verrouiller à nouveau ultérieurement.');
define('_PNFORUM_UNLOCKTOPIC','Déverrouiller ce sujet');
define('_PNFORUM_UNREGISTERED','Utilisateur non enregistré');
define('_PNFORUM_UNSTICKYTOPIC_INFO', 'Quand vous pressez le bouton de décollage à la fin de ce formulaire, le sujet sélectionné sera <b>décollé</b>. Vous pourrez le recoller ultérieurement.');
