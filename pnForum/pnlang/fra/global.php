...
define('_PNFORUM_PREFS_MINPOSTINGSFORANCHOR', 'Nombre minimal de messages avant d\'insérer une ancre :<br /><em>une ancre permet à l\'utilisateur d\'aller directement au dernier message dans un vaste fil de discussion</em>');
