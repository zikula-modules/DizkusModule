...
// C
//
define('_DZK_CANCELPOST','Cancel Post');
...
define('_DZK_PNPASSWORD', 'PN password');
define('_DZK_PNPASSWORDCONFIRM', 'PN password confirmation');
