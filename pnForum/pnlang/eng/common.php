...
// new
define('_PNFORUM_SEARCHWHERE', 'Search in');
...
define('_PNFORUM_ADMINHONORARYRANKS','Edit honorary ranks');
define('_PNFORUM_ADMINHONORARYRANKS_INFO','This link will allow you to create special ranks for special users.');
...
define('_PNFORUM_SEARCHRESULTSFOR','Search results for');
