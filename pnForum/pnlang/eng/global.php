 ...
 * New in 1.7.3.1 CVS
 */
define('_PNFORUM_BBCODE_WEBADDRESS','BBCode: Web address');
define('_PNFORUM_BBCODE_EMAILADDRESS','BBCode: Email Address');
define('_PNFORUM_BBCODE_WEBIMAGE','BBCode: Load Image from Web');
define('_PNFORUM_BBCODE_BOLD_TEXT','BBCode: Bold Text');
define('_PNFORUM_BBCODE_ITALIC_TEXT','BBCode: Italic Text');
define('_PNFORUM_BBCODE_QUOTE_TEXT','BBCode: Quote');
define('_PNFORUM_BBCODE_CODE_TEXT','BBCode: Code');
define('_PNFORUM_BBCODE_LIST_OPEN','BBCode: Open list');
define('_PNFORUM_BBCODE_LIST_ITEM','BBCode: List item');
define('_PNFORUM_BBCODE_LIST_CLOSE','BBCode: Close list');
