...
define('_PNFORUM_BBCODE_CODE_HINT', 'insert code');
define('_PNFORUM_BBCODE_LISTOPEN_HINT', 'open list');
define('_PNFORUM_BBCODE_LISTITEM_HINT', 'add list entry');
define('_PNFORUM_BBCODE_LISTCLOSE_HINT', 'close list');
define('_PNFORUM_BBCODE_BOLD_HINT', 'bold text');
define('_PNFORUM_BBCODE_ITALIC_HINT', 'italic text');
define('_PNFORUM_BBCODE_UNDERLINE_HINT', 'underlined text');
define('_PNFORUM_BBCODE_COLOR_HINT', 'select font color');
define('_PNFORUM_BBCODE_SIZE_HINT', 'select font size');

define('_PNFORUM_BBCODE_URL', 'URL');
define('_PNFORUM_BBCODE_MAIL', 'Email');
...
define('_PNFORUM_BBCODE_FONTSIZE', 'Font size');
define('_PNFORUM_BBCODE_FONTCOLOR', 'Font color');
...
define('_PNFORUM_BBCODE_COLOR_BROWN', 'Brown');
define('_PNFORUM_BBCODE_COLOR_YELLOW', 'Yellow');
define('_PNFORUM_BBCODE_COLOR_GREEN', 'Green');
define('_PNFORUM_BBCODE_COLOR_OLIVE', 'Olive');
define('_PNFORUM_BBCODE_COLOR_CYAN', 'Cyan');
define('_PNFORUM_BBCODE_COLOR_BLUE', 'Blue');
define('_PNFORUM_BBCODE_COLOR_DARKBLUE', 'Dark Blue');
define('_PNFORUM_BBCODE_COLOR_INDIGO', 'Indigo');
define('_PNFORUM_BBCODE_COLOR_VIOLET', 'Violet');
define('_PNFORUM_BBCODE_COLOR_WHITE', 'White');
define('_PNFORUM_BBCODE_COLOR_BLACK', 'Black');
define('_PNFORUM_BBCODE_COLOR_DEFINE', 'self defined color');
define('_PNFORUM_BBCODE_COLOR_TEXTCOLORCODE', 'enter color code');

define('_PNFORUM_BBCODE_SIZE_TINY', 'Tiny');
define('_PNFORUM_BBCODE_SIZE_SMALL', 'Small');
define('_PNFORUM_BBCODE_SIZE_NORMAL', 'Normal');
define('_PNFORUM_BBCODE_SIZE_LARGE', 'Large');
define('_PNFORUM_BBCODE_SIZE_HUGE', 'Huge');
define('_PNFORUM_BBCODE_SIZE_DEFINE', 'self defined size');
define('_PNFORUM_BBCODE_SIZE_TEXTSIZE', 'enter text size');
...
define('_PNFORUM_PREFS_POSTSPERPAGE', 'Posts per Page:<br /><i>(This is the number of posts per topic that will be displayed per page of a topic. 15 by default.)</i>');
define('_PNFORUM_PREFS_TOPICSPERPAGE', 'Topics per Forum:<br /><i>(This is the number of topics per forum that will be displayed per page of a forum. 15 by default.)</i>');
 ...
 * New in 1.7.3.1 CVS
 */
define('_PNFORUM_BBCODE_ENTER_URL','Enter the URL for the link you want to add');
define('_PNFORUM_BBCODE_ENTER_SITE_TITLE','Enter the web site title');
define('_PNFORUM_BBCODE_ENTER_PAGE_TITLE','Page title');
define('_PNFORUM_BBCODE_ENTER_EMAIL_ADDRESS','Enter the email address you want to add');
define('_PNFORUM_BBCODE_ENTER_TEXT_BOLD','Enter the text that you want to make bold');
...
define('_PNFORUM_USEBBCODE',"Click on the buttons to add <a href=\"modules.php?op=modload&amp;name=Messages&amp;file=bbcode_ref\" target=\"_blank\">BBCode</a> to your message:");
define('_PNFORUM_OKTODELETE',"delete?");
define('_PNFORUM_REPLY_POST',"Reply to");
define('_PNFORUM_MOVETOPICTO','Move topic to:');

/**
 * alphabetical defines
 */
...
define('_PNFORUM_ADMINWORDS_INFO','Here you can add/edit/delete bad words that will be filtered and replaced with others on your site');
define('_PNFORUM_ADMINWORDS_NOINBASE','No records currently in database');
define('_PNFORUM_ASSIGN','Assign');
define('_PNFORUM_AUTHOR',"Author");

define('_PNFORUM_BAD_WORDS','Bad words');
...
define('_PNFORUM_DELETETOPIC_INFO', 'When you press the delete button at the bottom of this form the topic you have selected, and all its related posts, will be <b>permanently</b> removed.');
...
define('_PNFORUM_LOCKTOPIC_INFO', 'When you press the lock button at the bottom of this form the topic you have selected will be <b>locked</b>. You may unlock it at a later time if you like.');
...
define('_PNFORUM_MOVETOPIC_INFO', 'When you press the move button at the bottom of this form the topic you have selected, and its related posts, will be <b>moved</b> to the forum you have selected. Note: You will only be able to move to a forum where you are moderator. Administrator is allowed to move any topic to any forum.');
...
define('_PNFORUM_NOTEDIT',"You can't edit a post that isn't yours.");
//define('_PNFORUM_NOTIFYBODY',"on %s forums\n%s\n:: %s\n::.. %s\n\n%s wrote at %s\n---------------------------------------------------------------------\n%s\n---------------------------------------------------------------------\n\nReply to this message:\n%s\n\nBrowse thread:\n%s\n");
...
define('_PNFORUM_STICKYTOPIC_INFO', 'When you press the sticky button at the bottom of this form the topic you have selected will be made <b>\'sticky\'</b>. You may unstick it again at a later time if you like.');
...
define('_PNFORUM_UNLOCKTOPIC_INFO', 'When you press the unlock button at the bottom of this form the topic you have selected will be <b>unlocked</b>. You may lock it again at a later time if you like.');
define('_PNFORUM_UNREGISTERED',"Unregistered User"); //use of config var
define('_PNFORUM_UNSTICKYTOPIC',"Unsticky topic");
define('_PNFORUM_UNSTICKYTOPIC_INFO', 'When you press the unstick button at the bottom of this form the topic you have selected will be <b>\'unstuck\'</b>. You may mark it sticky it again at a later time if you like.');
