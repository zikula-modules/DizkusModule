...
define('_DZK_ADMINREORDERTREE_INFO', 'Hier lässt sich die Sortierung der Kategorien unnd Foren ändern');
...
define('_DZK_ACTIVE_FORUMS','aktivste Foren:');
define('_DZK_ACTIVE_POSTERS','aktivste Autoren:');
define('_DZK_ADD','Hinzufügen');
...
define('_DZK_ADMINBADWORDS_TITLE','Wortersatz Administration');
define('_DZK_ADMINCATADD','Kategorie hinzufügen');
define('_DZK_ADMINCATADD_INFO','Anlegen einer neuen Kategorie, die dann Foren beinhalten kann');
define('_DZK_ADMINCATDELETE','Kategorie entfernen');
define('_DZK_ADMINCATDELETE_INFO','Entfernt eine Kategorie aus der Datenbank');
define('_DZK_ADMINCATEDIT','Kategorie editieren');
...
define('_DZK_ADMINFORUMEDIT_INFO','Editieren von Foren-Titeln');
define('_DZK_ADMINFORUMOPTIONS','Basiskonfiguration');
define('_DZK_ADMINFORUMOPTIONS_INFO','Grundeinstellungen des Dizkuss');
define('_DZK_ADMINFORUMORDER','Foren anordnen');
define('_DZK_ADMINFORUMORDER_INFO','Reihenfolge der Foren innerhalb einer Kategorie einstellen');
...
// B
//
define('_DZK_BACKTOFORUMADMIN', 'Zurück zur Forenadministration');
define('_DZK_BACKTOSUBMISSION', 'Zu diesem Beitrag gehen');
define('_DZK_BASEDONLASTXMINUTES', 'Diese Angaben basieren auf den Useraktivitäten der letzten %m% Minuten');
define('_DZK_BLOCK_PARAMETERS', 'Parameter');
define('_DZK_BLOCK_PARAMETERS_HINT', 'kommaseparierte Liste,z.B. maxposts=5,forum_id=27 ');
define('_DZK_BLOCK_TEMPLATENAME', 'Name der Templatedatei');
define('_DZK_BODY','Beitrag');
define('_DZK_BOTTOM', 'Zum aktuellsten Beitrag');
...
// D
//
define('_DZK_DATABASEINUSE', 'verwendete Datenbank');
define('_DZK_DATE','Datum');
define('_DZK_DELETE','Beitrag löschen');
...
// E
//
define('_DZK_EDITBY','editiert von:');
...
define('_DZK_EMAIL_TOPIC','Als Email versenden');
...
define('_DZK_ERROROCCURED', 'Folgender Fehler ist aufgetreten:');
define('_DZK_ERROR_CONNECT','Fehler bei der Datenbank-Verbindung!<br />');
define('_DZK_EXTENDEDOPTIONSAFTERSAVING', 'Erweiterte Einstellungen nach dem Speichern verfügbar');
define('_DZK_EXTERNALSOURCE', 'externe Quelle');
define('_DZK_EXTERNALSOURCEURL_HINT', 'Bei RSS-Quellen ist hier die ID des Feeds zu hinterlegen, wie sie im RSS Modul verwendet wird.');
...
define('_DZK_GOTO_TOPIC','gehe zum Thema');
define('_DZK_GROUP', 'Gruppe');
...
define('_DZK_HOTNEWTOPIC', 'Vielgelesenes Thema mit neuen Beiträgen');
...
define('_DZK_ISLOCKED','Thema ist abgeschlossen (keine neuen Beiträge möglich)');

//
// J
//
define('_DZK_JOINTOPICS', 'Themen zusammenfassen');
define('_DZK_JOINTOPICS_INFO', 'Fügt das aktuelle Thema an das folgende Thema an');
define('_DZK_JOINTOPICS_TOTOPIC', 'Zielthema');

//
// L
//
define('_DZK_LAST','vergangene');
define('_DZK_LAST24','vergangene 24 Stunden');
define('_DZK_LASTCHANGE','letzte Änderung am');
define('_DZK_LASTPOST','Datum');
define('_DZK_LASTPOSTINGBY', 'letzter Beitrag von');
define('_DZK_LASTPOSTSTRING','%s<br />von %s');
define('_DZK_LASTVISIT', 'letzter Besuch');
...
define('_DZK_MODERATE','Moderieren');
define('_DZK_MODERATEDBY','moderiert von');
define('_DZK_MODERATE_JOINTOPICS_HINT', 'Falls Themen zusammengefasst werden, wird hier das Zielthema gewählt');
define('_DZK_MODERATE_MOVETOPICS_HINT','Falls Themen verschoben werden, wird hier das Zielforum ausgewählt');
define('_DZK_MODERATION_NOTICE', 'Moderationshinweis');
define('_DZK_MODERATOR','Moderator');
define('_DZK_MODERATORSOPTIONS', 'Moderationsoptionen');
define('_DZK_MODULEREFERENCE', 'Modulreferenz');
define('_DZK_MODULEREFERENCE_HINT', 'Wird für die Kommentarfunktion verwendet. Neue Themen zu Einträgen in diesem Modul landen hier. In dieser Liste erscheinen nur Module, für die die Dizkushooks aktiviert sind.');
...
define('_DZK_MOVETOPICS','Themen verschieben');
define('_DZK_MOVETOPICTO','Thema verschieben nach:');
define('_DZK_MOVETOPIC_INFO', '<strong>Thema verschieben</strong> verschiebt den ausgewählten Beitrag in ein anderes Forum');
...
define('_DZK_NOAUTHPOST','Anmerkung: keine Berechtigung, Beiträge zu verfassen');
define('_DZK_NOAUTH_MODERATE','das können nur Moderatoren');
define('_DZK_NOAUTH_TOADMIN', 'Sie haben keine Berechtigung, dieses Modul zu administrieren');
define('_DZK_NOAUTH_TOMODERATE', 'Sie haben keine Berechtigung, diese Kategorie oder dieses Forum zu moderieren');
define('_DZK_NOAUTH_TOREAD', 'Sie haben keine Berechtigung, sich den Inhalt dieser Kategorie oder dieses Forums anzeigen zu lassen');
define('_DZK_NOAUTH_TOSEE', 'Sie haben keine Berechtigung, diese Kategorie oder dieses Forum zu sehen');
define('_DZK_NOAUTH_TOWRITE', 'Sie haben keine Berechtigung, in diese Kategorie oder dieses Forum zu schreiben');
define('_DZK_NOCATEGORIES', 'Keine Kategorien angelegt');
...
define('_DZK_NOMODERATORSASSIGNED', 'kein Moderator zugeordnet');
define('_DZK_NOMOVETO', 'Kein Zielforum zum Verschieben angegeben');
define('_DZK_NONE', 'keiner');
define('_DZK_NONEWPOSTS','keine neuen Beiträge seit letztem Besuch');
define('_DZK_NOPNTOPIC', 'kein Topic');
define('_DZK_NOPOSTLOCK','Thema abgeschlossen, keine Antwort möglich');
define('_DZK_NOPOSTS','Keine Beiträge');
define('_DZK_NORANK', 'kein Rang');
define('_DZK_NORANKSINDATABASE', 'Keine Ränge definiert');
define('_DZK_NORMALNEWTOPIC', 'Normales Thema mit neuen Beiträgen');
define('_DZK_NORMALTOPIC', 'Normales Thema');
define('_DZK_NOSMILES','keine Smilies in der Datenbank');
define('_DZK_NOSPECIALRANKSINDATABASE', 'Keine bneutzerdefinierten Ränge vorhanden');
define('_DZK_NOSUBJECT', 'kein Betreff');
define('_DZK_NOTEDIT','nur eigene Beiträge können editiert werden');
define('_DZK_NOTIFYBODY1','Foren-Abo');
define('_DZK_NOTIFYBODY2','schrieb am');
define('_DZK_NOTIFYBODY3','Beantwortung der Nachricht:');
define('_DZK_NOTIFYBODY4','Thema aufrufen:');
define('_DZK_NOTIFYBODY5','Versand aufgrund eines Forenabos bei:');
define('_DZK_NOTIFYBODY6', 'Link zur Verwaltung der Themen- und Forenabos:');
define('_DZK_NOTIFYME', 'Benachrichtigung bei Antworten');
define('_DZK_NOTIFYMODBODY1', 'Moderationsanfrage');
...
define('_DZK_NOTSUBSCRIBED','Fehler - das Forum ist nicht abonniert');
define('_DZK_NOUSER_OR_POST','Fehler - kein solcher Beitrag/Benutzer in der Datenbank');
define('_DZK_NO_FORUMS_DB', 'keine Foren in der Datenbank');
define('_DZK_NO_FORUMS_MOVE', 'es werden keine weiteren Foren moderiert');

//
// O
//
define('_DZK_OFFLINE', 'offline');
define('_DZK_OKTODELETE','löschen?');
define('_DZK_OLDEST_FIRST','Ältesten Beitrag zuerst anzeigen');
define('_DZK_ONEREPLY','Antwort');
...
// P
//
define('_DZK_PAGE','Seite');
define('_DZK_PASSWORD', 'Kennwort');
...
define('_DZK_PNPASSWORD', 'PN Kennwort');
define('_DZK_PNPASSWORDCONFIRM', 'PN Kennwort bestätigen');
define('_DZK_PNTOPIC', 'Zikula Topic');
define('_DZK_PNTOPIC_HINT', '');
define('_DZK_PNUSER', 'PN Username');
define('_DZK_POP3ACTIVE', 'Mail2Forum aktivieren');
define('_DZK_POP3INTERVAL', 'Prüfintervall');
define('_DZK_POP3LOGIN', 'Pop3 Login');
define('_DZK_POP3MATCHSTRING', 'Regel');
define('_DZK_POP3MATCHSTRINGHINT', 'Die Regel ist ein regulärer Ausdruck, auf den der Betrefftext der Mail zustimmen muss. Dies dient dem Vermeiden von Spampostings. Eine leere Regel bedeutet keine Überprüfung des Emailbetreffs!');
define('_DZK_POP3PASSWORD', 'Pop3 Kennwort');
define('_DZK_POP3PASSWORDCONFIRM', 'Pop3 Kennwort bestätigen');
define('_DZK_POP3PORT', 'Pop3 Port');
define('_DZK_POP3SERVER', 'Pop3 Server');
define('_DZK_POP3TEST', 'Pop3 Test nach dem Speichern durchführen');
define('_DZK_POP3TESTRESULTS', 'Pop3 Testergebnisse');
define('_DZK_POST','Beitrag');
...
define('_DZK_PREFS_AUTOSUBSCRIBE', 'Neue Themen und Beiträge gleich abonnieren');
define('_DZK_PREFS_CHARSET', 'Zeichensatz:<br /><em>(Dies ist der Zeichensatz, der im Header der Emails benutzt wird)</em>');
define('_DZK_PREFS_DELETEHOOKACTION', 'Folgende Aktion beim Aufrufen des Deletehooks ausführen');
define('_DZK_PREFS_DELETEHOOKACTIONLOCK', 'Thema löschen');
define('_DZK_PREFS_DELTEHOOKACTIONREMOVE', 'Thema schliessen');
define('_DZK_PREFS_DESCENDING', 'Absteigend');
define('_DZK_PREFS_EMAIL', 'Absenderemail:<br /><em>(Diese Absendeadresse wird in den Emails der Forenbenachrichtigungen benutzt)</em>');
...
define('_DZK_PREFS_REMOVESIGNATUREFROMPOST', 'Usersignatur aus Postings entfernen');
define('_DZK_PREFS_RESTOREDEFAULTS', 'Standardwerte wiederherstellen');
define('_DZK_PREFS_RSS2FENABLED', 'RSS2Forum aktivieren');
define('_DZK_PREFS_SAVE', 'Speichern');
define('_DZK_PREFS_SEARCHWITHFULLTEXTINDEX', 'Forumsuche mit Volltextindex');
define('_DZK_PREFS_SEARCHWITHFULLTEXTINDEX_HINT', '<i>Die Forensuche mit Volltextindexfeldern benötigt MySQL 4 oder höher und funktioniert nicht mit InnoDB Datenbanken. Dieses Flag wird üblicherweise bei der Installation gesetzt, wenn die entsprechenden Indexfelder angelegt werden. Es könnte sein, das eine Volltextsuche zu einem leeren Ergebnis führt, obwohl der Suchbegriff vorhanden ist.</i><br /><a href="http://dev.mysql.com/doc/mysql/en/fulltext-search.html" title="Volltextsuche in MySQL">Volltextsuche in MySQL</a>.');
...
define('_DZK_PRINT_POST','Beitrag drucken');
define('_DZK_PRINT_TOPIC','Thema drucken');
define('_DZK_PROFILE', 'Profil');

//
// Q
//
define('_DZK_QUICKREPLY', 'Schnelle Antwort');
define('_DZK_QUICKSELECTFORUM','bitte wählen');
...
define('_DZK_REMEMBERME', 'Username und Kennwort merken');
define('_DZK_REMOVE', 'entfernen');
define('_DZK_REMOVE_FAVORITE_FORUM','Favorit entfernen');
...
define('_DZK_REPLYLOCKED','geschlossen');
define('_DZK_REPLYQUOTE','zitieren');
define('_DZK_REPLY_POST','Antwort auf');
define('_DZK_REPORTINGUSERNAME', 'Einreicher');
...
// S
//
define('_DZK_SAVEPREFS','Foren-Abos abspeichern');
define('_DZK_SEARCH','Forum Suche');
define('_DZK_SEARCHALLFORUMS', 'alle Foren');
define('_DZK_SEARCHAND','alle Worte [UND]');
define('_DZK_SEARCHBOOL','Verknüpfung');
define('_DZK_SEARCHFOR','Suchen nach');
define('_DZK_SEARCHINCLUDE_ALLTOPICS', 'alle');
...
define('_DZK_SEARCHINCLUDE_HITS', 'Treffer');
define('_DZK_SEARCHINCLUDE_LIMIT', 'Suche beschränken auf');
define('_DZK_SEARCHINCLUDE_MISSINGPARAMETERS', 'Suchparameter fehlen');
define('_DZK_SEARCHINCLUDE_NEWWIN','in neuem Fenster öffnen');
define('_DZK_SEARCHINCLUDE_NOENTRIES','keine Forenbeiträge gefunden');
define('_DZK_SEARCHINCLUDE_NOLIMIT', 'unbeschränkt');
define('_DZK_SEARCHINCLUDE_ORDER','Reihenfolge');
define('_DZK_SEARCHINCLUDE_REPLIES','Antworten');
...
define('_DZK_SELECTREFERENCEMODULE', 'Zielmodul auswählen');
define('_DZK_SELECTRSSFEED', 'RSS Feed auswählen');
define('_DZK_SELECTTARGETFORUM', 'Zielforum wählen');
define('_DZK_SELECTTARGETTOPIC', 'Zielthema wählen');
define('_DZK_SENDTO','Senden an');
define('_DZK_SEND_PM', 'PM senden');
...
define('_DZK_SUBMIT_HINT','ACHTUNG: Es erfolgt keine weitere Bestätigung. Themen werden direkt gelöscht/geschlossen/markiert...');
define('_DZK_SUBSCRIBE_FORUM','Forum abonnieren');
define('_DZK_SUBSCRIBE_STATUS','Abo-Status');
define('_DZK_SUBSCRIBE_TOPIC','Thema abonnieren');
define('_DZK_SYNC_FORUMINDEX', 'Forumindex neu erstellt');
define('_DZK_SYNC_POSTSCOUNT', 'Beitragszähler neu erstellt');
define('_DZK_SYNC_TOPICS', 'Themenindex neu erstellt');
define('_DZK_SYNC_USERS', 'Zikula und Dizkus User synchronisiert');
...
define('_DZK_TOPICS','Themen');
define('_DZK_TOPIC_NOEXIST','Fehler - Beitrag existiert nicht');
define('_DZK_TOPIC_STARTER','gestartet von');
define('_DZK_TOTAL','Gesamtstatistik');

//
// U
//
define('_DZK_UALASTWEEK', 'letzte Woche, unbeantwortet');
define('_DZK_UNKNOWNIMAGE', 'unbekannte Grafik');
define('_DZK_UNKNOWNUSER', '**unbekannter Benutzer**');
define('_DZK_UNLOCKTOPIC','Thema eröffnen');
define('_DZK_UNLOCKTOPICS','Themen eröffnen');
define('_DZK_UNLOCKTOPIC_INFO', '<strong>Thema eröffnen</strong> eröffnet diesen Beitrag - er kann aber jederzeit wieder abgeschlossen werden');
define('_DZK_UNREGISTERED','unregistrierter Benutzer');
define('_DZK_UNSTICKYTOPIC','Markierung aufheben');
define('_DZK_UNSTICKYTOPICS','Markierungen aufheben');
define('_DZK_UNSTICKYTOPIC_INFO', '<strong>Markierung aufheben</strong> hebt die Markierung dieses Beitrages auf - er kann aber jederzeit wieder markiert werden');
define('_DZK_UNSUBSCRIBE_FORUM','Forenabo ausschalten');
...
define('_DZK_USERS_RANKS','Benutzerränge');
define('_DZK_USER_IP', 'Benutzer IP');
